...
brain-progression:
	poetry run brain-arogression
brain-prime:
	poetry run brain-prime

.PHONY: install brain-games build package-install publish lint reinstall-package brain-calc brain-even brain-gcd brain-progression brain-prime
